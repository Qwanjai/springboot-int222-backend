...
import int222.backend.models.exceptions.*;
...
public class ControllerAdvisor {
    ...
    public ResponseEntity<ErrorMessage> unSupportMediaTypeException(UnsupportedMediaTypeException ex, WebRequest request) {
        ErrorMessage message = new ErrorMessage(
                HttpStatus.CONFLICT.value(),
                new Date(),
                ex.getMessage(),
